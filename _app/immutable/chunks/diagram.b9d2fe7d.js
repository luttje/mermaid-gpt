import{w as s}from"./paths.97758f16.js";const d=`You will generate ERDiagram code for a system description. It should be formatted like this example:
...
ERDiagram code: `,max_tokens:2e3,top_p:.1};console.log({promptBody:t});const r=await fetch("https://api.openai.com/v1/completions",{method:"POST",headers:{"Content-Type":"application/json",Authorization:`Bearer ${o}`},body:JSON.stringify(t)});console.log(r);const i=(await r.json()).choices[0].text;e(i)},reset:()=>e(null)}}const g=m();export{g as d};
